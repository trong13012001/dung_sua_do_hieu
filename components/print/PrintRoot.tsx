...
function setupPrintRoot() {
  ...
  const visibleLabels = [...labelRoots].filter(isElementVisibleForPrint);
  if (visibleLabels.length > 0) {
    /* Chỉ một khối tem — nếu có nhiều node .item-labels-print (hiếm) tránh in 2 trang / trùng */
    const el = visibleLabels.at(-1);
    if (el) {
